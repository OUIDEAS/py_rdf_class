def get_feats():
    ...
    StandDevHeight_bool             = 1
    MeanHeight_bool                 = 0
    MinHeight_bool                  = 0
    MaxHeight_bool                  = 0
    MedHeight_bool                  = 0
    RoughnessHeight_bool            = 1
    MinMaxRatioHeight_bool          = 1
    Min2MaxRatioHeight_bool         = 1
    MagGradientHeight_bool          = 1

    # Examining the height from reference plane / XY Distance
    StandDevHeightXYDist_bool       = 1
    MeanHeightXYDist_bool           = 0
    MinHeightXYDist_bool            = 0
    MaxHeightXYDist_bool            = 0
    MedHeightXYDist_bool            = 0
    RoughnessHeightXYDist_bool      = 1
    MinMaxRatioHeightXYDist_bool    = 1
    Min2MaxRatioHeightXYDist_bool   = 1
    MagGradientHeightXYDist_bool    = 1

    # Examining the height from reference plane / Range to LiDAR
    StandDevHeightRange_bool        = 1
    MeanHeightRange_bool            = 0
    MinHeightRange_bool             = 0
    MaxHeightRange_bool             = 0
    MedHeightRange_bool             = 0
    RoughnessHeightRange_bool       = 1
    MinMaxRatioHeightRange_bool     = 1
    Min2MaxRatioHeightRange_bool    = 1
    MagGradientHeightRange_bool     = 1
    ...
    feat_bool_array = [StandDevHeight_bool, 
    MeanHeight_bool, 
    MinHeight_bool, 
    MaxHeight_bool, 
    MedHeight_bool, 
    ...
    # print(type(feat_bool_array))

    # Grabbing the indexes of all the ones
    col_array = []

    for idx, value in enumerate(feat_bool_array):
            if value == 1:
                col_array.append(idx)
